...
pairing code — typically by passing it over another channel (e.g. DMs).
...
Pair via QR or typed code, then over Tor:
...
or types it in after receiving it over DMs or another channel:
